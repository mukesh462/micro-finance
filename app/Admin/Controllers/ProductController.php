...
class ProductController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->decimal('plan_amount', __('Product amount'))->rules(['required', 'numeric', 'min:1']);
        ...
        $form->radio('plan_type', __('Product type'))->required()->options([1 => 'Weekly', 2 => "15 days", 3 => 'Montly']);
        $form->number('plan_duration', __('Product duration'))->min(1)->required();
