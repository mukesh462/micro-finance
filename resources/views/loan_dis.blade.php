        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Are you sure want to Reset</h5>
                ...
                <div class="modal-body">
                    <p>
                        ...
                        ></i>
                        All Change should be clear automatically
                    </p>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form
                        ...
                        action="{{ admin_url('loan_disbrusment') }}"
                        method="post"
                    >
                        ...
                        @csrf
                        <button id="" class="btn btn-primary">Ok</button>
                    </form>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-3 col-lg-3">
            <label for="" id="Center-error">Select Center </label>
            <select name="" class="form-control" id="Center"></select>
        </div>
        <div class="col-12 col-md-3 col-lg-3">
            <label for="" id="Index-error">Select Index </label>
            {{-- @php
        ...
        <div class="col-12 col-md-3 col-lg-3">
            <label for="">Index Date </label>
            <input type="text" class="form-control" id="index_date" disabled />
        </div>
        <div class="col-12 col-md-3 col-lg-3">
            <label for="fund" id="fund-error">Select Fund </label>
        ...
        <div class="col-12 col-md-3 col-lg-3">
            <label for="type" id="type-error">Disbursal Type </label>
        ...
        <div class="col-12 col-md-3 col-lg-3">
            <label for="approve">Approve Count </label>
            <input
                type="text"
                class="form-control"
                value="0"
        ...
        <div class="col-12 col-md-3 col-lg-3">
            <label for="Due" id="Due-error">First Due </label>
            <input
                type="text"
                class="form-control"
                id="Due"
        ...
        <div class="col-12 col-md-3 col-lg-3 search-btn">
            <button class="btn btn-info" id="search-max" type="button">
                <i class="fa fa-search"></i> Search
            </button>
            <button class="btn btn-warning" id="rest-btn">
    ...
    >
        <table class="table">
            <thead>
                ...
                <td class="checkAll">
                    <label for="masterCheckbox"> Check All </label
...
<script src="{{
        asset('/vendor/laravel-admin/moment/min/moment-with-locales.min.js')
    }}"></script>
            ...
            if (checkField(valObj)) {
                ...
                $.ajax({
                    ...
                    success: function ({ results }) {
                        ...
                        $("#list-table").html("");
                        const total_amount_table = results.reduce(
                            (acc, pre) => acc + pre.plan_amount,
                            0
                        );
                    ...
                    <td>
                        <div class="switch__container">
                            <input id="switch-shadow${
                                i * 45
                            }" class="switch switch--shadow selected_value" value='${JSON.stringify(
                                dat
                            )}' type="checkbox">
            ...
            if ($(this).val() != "") {
                $.ajax({
                    ...
                    success: function ({ results }) {
                        ...
                        results.forEach((e) => {
                            $("#Index").append(
                                `<option data-value='${JSON.stringify(
                                    e
                                )}' value='${e.id}'>${e.index_no}</option>`
                            );
                        });
                    },
                });
